...
<body>
  ...
  <div class="main">
    ...
    <div class="subtitle">Know Your Numbers. Monitor Your Progress.</div>
      ...
      <button class= "patientLogin" type="submit" onclick="goToLogin()"><i class="uil--login"></i>
        Patient Login</button>
       
      <button class="newPatient"type="submit" onclick="goToCreatePatient()"> <i class="bxs--user-plus "></i>
         RegisterNew Patient</button>
